...
namespace myTiles {
    ...
    helpers.registerTilemapFactory(function(name: string) {
        switch(helpers.stringTrim(name)) {
            case "level": return tiles.createTilemap(hex`0a000a0005060606060606060607040909090909090909080409090909090909090804090909090909090908040909090909090909080409090909090909090804090909090909090908040909090909090909080409090909090909090803020202020202020201`, img`
2 2 2 2 2 2 2 2 2 2 
2 . . . . . . . . 2 
2 . . . . . . . . 2 
2 . . . . . . . . 2 
